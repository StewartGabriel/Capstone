...
public class PianoKeyboardSetup : MonoBehaviour
{
    ...
    private ListeningBoard pianoInstance;

    private bool isLeftAnchorSet = false;
    private bool isSettingAnchors = false; // Control when anchors can be set

    private PianoHandle leftAnchorPosition;
    private PianoHandle rightAnchorPosition;
    ...
    void Start()
    {
        leftAnchorPosition = pianoInstance.lefthandle;
        rightAnchorPosition = pianoInstance.righthandle;
    ...
    void Update()
    {
        ...
        if (DetectKeyPress(out float detectedFrequency))
        {
            ...
            if (!isLeftAnchorSet)
            {
                ...
                leftAnchorPosition.transform.position = MapFrequencyToPosition(detectedFrequency);
            ...
            else
            {
                ...
                rightAnchorPosition.transform.position = MapFrequencyToPosition(detectedFrequency);
        ...
        {
            leftAnchorPosition.transform.position = leftKeyPosition;
            isLeftAnchorSet = true;
        ...
        {
            rightAnchorPosition.transform.position = rightKeyPosition;
    ...
    {
        isLeftAnchorSet = false;
        leftAnchorPosition.transform.position = UnityEngine.Vector3.zero;
        rightAnchorPosition.transform.position = UnityEngine.Vector3.zero;
